public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: had to take off 1's and change to 0 to get to start of index
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: had to change to Add instead of Insert and take off the 0 so it added it to the end
